...
export function meta({ params }: Route.MetaArgs) {
	...
	const metaData = {
		...
		en: {
			...
			description:
				"Comprehensive FAQ for TempMail temporary email: How to use disposable email, email retention time, attachment downloads, privacy security, etc. Quickly find answers for using temporary email service.",
		},
		ja: {
			title:
				"よくある質問 - TempMail一時メールサービスガイド＆トラブルシューティング",
			description:
				"TempMail一時メールの包括的なFAQ：使い捨てメールの使用方法、メール保存期間、添付ファイルのダウンロード、プライバシーセキュリティなど。一時メールサービスの使用に関する回答を素早く見つけられます。",
		},
	};
